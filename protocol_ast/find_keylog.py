...
def pick_pcap_for_keylog(
    ...
    *,
    ...
    max_bytes defaults to 64MB so typical PCAPdroid game dumps (~10–20MB)
    are scored; the old 12MB cap skipped Jul-27 captures and fell back to
    tiny mismatched dumps.
    """
    try:
